...
// import { db } from "@/app/lib/prisma" // 替換成你的 prisma 實例路徑
// import bcrypt from "bcryptjs"

// export const { handlers, auth, signIn, signOut } = NextAuth({
//   adapter: PrismaAdapter(db),
//   session: { strategy: "jwt" }, // 使用 Credentials 必須搭配 JWT
//   pages: {
//     signIn: "/login", // 自訂登入頁面路徑 (你要自己刻一個 /app/login/page.tsx)
//   },
//   providers: [
//     CredentialsProvider({
//       name: "Credentials",
